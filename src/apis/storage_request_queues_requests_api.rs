...
/// struct for typed errors of method [`request_queue_request_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueRequestDeleteError {
...
/// struct for typed errors of method [`request_queue_request_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueRequestGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`request_queue_request_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueRequestPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`request_queue_requests_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueRequestsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`request_queue_requests_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueRequestsPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn request_queue_request_delete(configuration: &configuration::Configuration, queue_id: &str, request_id: &str, client_key: Option<&str>) -> Result<(), Error<RequestQueueRequestDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    let p_path_request_id = request_id;
    let p_query_client_key = client_key;

    let uri_str = format!("{}/v2/request-queues/{queueId}/requests/{requestId}", configuration.base_path, queueId=crate::apis::urlencode(p_path_queue_id), requestId=crate::apis::urlencode(p_path_request_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<RequestQueueRequestDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns request from queue.
pub async fn request_queue_request_get(configuration: &configuration::Configuration, queue_id: &str, request_id: &str) -> Result<models::RequestResponse, Error<RequestQueueRequestGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    let p_path_request_id = request_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueueRequestGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn request_queue_request_put(configuration: &configuration::Configuration, queue_id: &str, request_id: &str, request: models::Request, forefront: Option<&str>, client_key: Option<&str>) -> Result<models::UpdateRequestResponse, Error<RequestQueueRequestPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    let p_path_request_id = request_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueueRequestPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn request_queue_requests_get(configuration: &configuration::Configuration, queue_id: &str, client_key: Option<&str>, exclusive_start_id: Option<&str>, limit: Option<f64>, cursor: Option<&str>, filter: Option<Vec<String>>) -> Result<models::ListOfRequestsResponse, Error<RequestQueueRequestsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    let p_query_client_key = client_key;
    ...
    let uri_str = format!("{}/v2/request-queues/{queueId}/requests", configuration.base_path, queueId=crate::apis::urlencode(p_path_queue_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueueRequestsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn request_queue_requests_post(configuration: &configuration::Configuration, queue_id: &str, request_base: models::RequestBase, client_key: Option<&str>, forefront: Option<&str>) -> Result<models::AddRequestResponse, Error<RequestQueueRequestsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueueRequestsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
