...
/// struct for typed errors of method [`tools_browser_info_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ToolsBrowserInfoDeleteError {
    Status405(models::ErrorResponse),
    Status429(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`tools_browser_info_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ToolsBrowserInfoGetError {
    Status405(models::ErrorResponse),
    Status429(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`tools_browser_info_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ToolsBrowserInfoPostError {
    Status405(models::ErrorResponse),
    Status429(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`tools_browser_info_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ToolsBrowserInfoPutError {
    Status405(models::ErrorResponse),
    Status429(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`tools_decode_and_verify_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ToolsDecodeAndVerifyPostError {
...
/// struct for typed errors of method [`tools_encode_and_sign_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ToolsEncodeAndSignPostError {
    Status400(models::ErrorResponse),
...
pub async fn tools_browser_info_delete(configuration: &configuration::Configuration, skip_headers: Option<bool>, raw_headers: Option<bool>) -> Result<models::BrowserInfoResponse, Error<ToolsBrowserInfoDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_skip_headers = skip_headers;
    let p_query_raw_headers = raw_headers;

    let uri_str = format!("{}/v2/browser-info", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);

    if let Some(ref param_value) = p_query_skip_headers {
        req_builder = req_builder.query(&[("skipHeaders", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_raw_headers {
        req_builder = req_builder.query(&[("rawHeaders", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::BrowserInfoResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::BrowserInfoResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ToolsBrowserInfoDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns information about the HTTP request, including the client IP address, country code, request headers, and body length.  This endpoint is designed for proxy testing. It accepts any HTTP method so you can verify that your proxy correctly forwards requests of any type and that client IP addresses are anonymized. 
pub async fn tools_browser_info_get(configuration: &configuration::Configuration, skip_headers: Option<bool>, raw_headers: Option<bool>) -> Result<models::BrowserInfoResponse, Error<ToolsBrowserInfoGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_skip_headers = skip_headers;
    let p_query_raw_headers = raw_headers;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ToolsBrowserInfoGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns information about the HTTP request, including the client IP address, country code, request headers, and body length.  This endpoint is designed for proxy testing. It accepts any HTTP method so you can verify that your proxy correctly forwards requests of any type and that client IP addresses are anonymized. 
pub async fn tools_browser_info_post(configuration: &configuration::Configuration, skip_headers: Option<bool>, raw_headers: Option<bool>) -> Result<models::BrowserInfoResponse, Error<ToolsBrowserInfoPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_skip_headers = skip_headers;
    let p_query_raw_headers = raw_headers;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ToolsBrowserInfoPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns information about the HTTP request, including the client IP address, country code, request headers, and body length.  This endpoint is designed for proxy testing. It accepts any HTTP method so you can verify that your proxy correctly forwards requests of any type and that client IP addresses are anonymized. 
pub async fn tools_browser_info_put(configuration: &configuration::Configuration, skip_headers: Option<bool>, raw_headers: Option<bool>) -> Result<models::BrowserInfoResponse, Error<ToolsBrowserInfoPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_skip_headers = skip_headers;
    let p_query_raw_headers = raw_headers;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ToolsBrowserInfoPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn tools_decode_and_verify_post(configuration: &configuration::Configuration, decode_and_verify_request: models::DecodeAndVerifyRequest) -> Result<models::DecodeAndVerifyResponse, Error<ToolsDecodeAndVerifyPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_decode_and_verify_request = decode_and_verify_request;

    let uri_str = format!("{}/v2/tools/decode-and-verify", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    req_builder = req_builder.json(&p_body_decode_and_verify_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DecodeAndVerifyResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DecodeAndVerifyResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ToolsDecodeAndVerifyPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn tools_encode_and_sign_post(configuration: &configuration::Configuration, body: serde_json::Value) -> Result<models::EncodeAndSignResponse, Error<ToolsEncodeAndSignPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/v2/tools/encode-and-sign", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::EncodeAndSignResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::EncodeAndSignResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ToolsEncodeAndSignPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
