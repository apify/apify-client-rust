...
/// struct for typed errors of method [`schedule_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ScheduleDeleteError {
...
/// struct for typed errors of method [`schedule_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`schedule_log_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ScheduleLogGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`schedule_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SchedulePutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`schedules_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SchedulesGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status405(models::ErrorResponse),
...
/// struct for typed errors of method [`schedules_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SchedulesPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// Deletes a schedule.
pub async fn schedule_delete(configuration: &configuration::Configuration, schedule_id: &str) -> Result<serde_json::Value, Error<ScheduleDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_schedule_id = schedule_id;

    let uri_str = format!("{}/v2/schedules/{scheduleId}", configuration.base_path, scheduleId=crate::apis::urlencode(p_path_schedule_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ScheduleDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Gets the schedule object with all details.
pub async fn schedule_get(configuration: &configuration::Configuration, schedule_id: &str) -> Result<models::ScheduleResponse, Error<ScheduleGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_schedule_id = schedule_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ScheduleGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Gets the schedule log as a JSON array containing information about up to a 1000 invocations of the schedule. 
pub async fn schedule_log_get(configuration: &configuration::Configuration, schedule_id: &str) -> Result<models::ScheduleLogResponse, Error<ScheduleLogGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_schedule_id = schedule_id;

    let uri_str = format!("{}/v2/schedules/{scheduleId}/log", configuration.base_path, scheduleId=crate::apis::urlencode(p_path_schedule_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScheduleLogResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScheduleLogResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ScheduleLogGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn schedule_put(configuration: &configuration::Configuration, schedule_id: &str, schedule_create: models::ScheduleCreate) -> Result<models::ScheduleResponse, Error<SchedulePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_schedule_id = schedule_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SchedulePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn schedules_get(configuration: &configuration::Configuration, offset: Option<f64>, limit: Option<f64>, desc: Option<bool>) -> Result<models::ListOfSchedulesResponse, Error<SchedulesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListOfSchedulesResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListOfSchedulesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SchedulesGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn schedules_post(configuration: &configuration::Configuration, schedule_create: models::ScheduleCreate) -> Result<models::ScheduleResponse, Error<SchedulesPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_schedule_create = schedule_create;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SchedulesPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
