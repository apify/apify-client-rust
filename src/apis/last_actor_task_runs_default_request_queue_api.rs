...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueDeleteError {
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_head_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueHeadGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_head_lock_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueHeadLockPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueuePutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_request_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueRequestDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_request_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueRequestGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_request_lock_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueRequestLockDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_request_lock_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueRequestLockPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_request_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueRequestPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_requests_batch_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueRequestsBatchDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_requests_batch_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueRequestsBatchPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_requests_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueRequestsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_requests_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueRequestsPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_request_queue_requests_unlock_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastRequestQueueRequestsUnlockPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn actor_task_runs_last_request_queue_delete(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>) -> Result<(), Error<ActorTaskRunsLastRequestQueueDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/request-queue", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ActorTaskRunsLastRequestQueueDeleteError> = serde_json::from_str(&content).ok();
...
pub async fn actor_task_runs_last_request_queue_get(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>) -> Result<models::RequestQueueResponse, Error<ActorTaskRunsLastRequestQueueGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RequestQueueResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RequestQueueResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_head_get(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>, limit: Option<f64>, client_key: Option<&str>) -> Result<models::HeadResponse, Error<ActorTaskRunsLastRequestQueueHeadGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;
    let p_query_limit = limit;
    let p_query_client_key = client_key;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/request-queue/head", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if let Some(ref param_value) = p_query_client_key {
        req_builder = req_builder.query(&[("clientKey", &param_value.to_string())]);
    }
    if let Some(ref apikey) = configuration.api_key {
        let key = apikey.key.clone();
        let value = match apikey.prefix {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::HeadResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::HeadResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueHeadGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_head_lock_post(configuration: &configuration::Configuration, actor_task_id: &str, lock_secs: f64, status: Option<&str>, limit: Option<f64>, client_key: Option<&str>) -> Result<models::HeadAndLockResponse, Error<ActorTaskRunsLastRequestQueueHeadLockPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_lock_secs = lock_secs;
    let p_query_status = status;
    let p_query_limit = limit;
    let p_query_client_key = client_key;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/request-queue/head/lock", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

    if let Some(ref param_value) = p_query_status {
        req_builder = req_builder.query(&[("status", &param_value.to_string())]);
    }
    req_builder = req_builder.query(&[("lockSecs", &p_query_lock_secs.to_string())]);
    if let Some(ref param_value) = p_query_limit {
        req_builder = req_builder.query(&[("limit", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_client_key {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::HeadAndLockResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::HeadAndLockResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueHeadLockPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_put(configuration: &configuration::Configuration, actor_task_id: &str, update_request_queue_request: models::UpdateRequestQueueRequest, status: Option<&str>) -> Result<models::RequestQueueResponse, Error<ActorTaskRunsLastRequestQueuePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_body_update_request_queue_request = update_request_queue_request;
    let p_query_status = status;
    ...
    req_builder = req_builder.json(&p_body_update_request_queue_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueuePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_request_delete(configuration: &configuration::Configuration, actor_task_id: &str, request_id: &str, status: Option<&str>, client_key: Option<&str>) -> Result<(), Error<ActorTaskRunsLastRequestQueueRequestDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    ...
    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/request-queue/requests/{requestId}", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id), requestId=crate::apis::urlencode(p_path_request_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueRequestDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_request_get(configuration: &configuration::Configuration, actor_task_id: &str, request_id: &str, status: Option<&str>) -> Result<models::RequestResponse, Error<ActorTaskRunsLastRequestQueueRequestGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_path_request_id = request_id;
    let p_query_status = status;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RequestResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RequestResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueRequestGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_request_lock_delete(configuration: &configuration::Configuration, actor_task_id: &str, request_id: &str, status: Option<&str>, client_key: Option<&str>, forefront: Option<&str>) -> Result<(), Error<ActorTaskRunsLastRequestQueueRequestLockDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_path_request_id = request_id;
    let p_query_status = status;
    let p_query_client_key = client_key;
    let p_query_forefront = forefront;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/request-queue/requests/{requestId}/lock", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id), requestId=crate::apis::urlencode(p_path_request_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if let Some(ref param_value) = p_query_forefront {
        req_builder = req_builder.query(&[("forefront", &param_value.to_string())]);
    }
    if let Some(ref apikey) = configuration.api_key {
        let key = apikey.key.clone();
        let value = match apikey.prefix {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueRequestLockDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_request_lock_put(configuration: &configuration::Configuration, actor_task_id: &str, request_id: &str, lock_secs: f64, status: Option<&str>, client_key: Option<&str>, forefront: Option<&str>) -> Result<models::ProlongRequestLockResponse, Error<ActorTaskRunsLastRequestQueueRequestLockPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_path_request_id = request_id;
    let p_query_lock_secs = lock_secs;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ProlongRequestLockResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ProlongRequestLockResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueRequestLockPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_request_put(configuration: &configuration::Configuration, actor_task_id: &str, request_id: &str, request: models::Request, status: Option<&str>, forefront: Option<&str>, client_key: Option<&str>) -> Result<models::UpdateRequestResponse, Error<ActorTaskRunsLastRequestQueueRequestPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_path_request_id = request_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UpdateRequestResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UpdateRequestResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueRequestPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_requests_batch_delete(configuration: &configuration::Configuration, actor_task_id: &str, content_type: &str, request_draft_delete: Vec<models::RequestDraftDelete>, status: Option<&str>, client_key: Option<&str>) -> Result<models::BatchDeleteResponse, Error<ActorTaskRunsLastRequestQueueRequestsBatchDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_header_content_type = content_type;
    let p_body_request_draft_delete = request_draft_delete;
    let p_query_status = status;
    let p_query_client_key = client_key;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/request-queue/requests/batch", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_request_draft_delete);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::BatchDeleteResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::BatchDeleteResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueRequestsBatchDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_requests_batch_post(configuration: &configuration::Configuration, actor_task_id: &str, request_base: Vec<models::RequestBase>, status: Option<&str>, client_key: Option<&str>, forefront: Option<&str>) -> Result<models::BatchAddResponse, Error<ActorTaskRunsLastRequestQueueRequestsBatchPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_body_request_base = request_base;
    let p_query_status = status;
    let p_query_client_key = client_key;
    let p_query_forefront = forefront;
    ...
    req_builder = req_builder.json(&p_body_request_base);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::BatchAddResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::BatchAddResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueRequestsBatchPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_requests_get(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>, client_key: Option<&str>, exclusive_start_id: Option<&str>, limit: Option<f64>, cursor: Option<&str>, filter: Option<Vec<String>>) -> Result<models::ListOfRequestsResponse, Error<ActorTaskRunsLastRequestQueueRequestsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;
    let p_query_client_key = client_key;
    let p_query_exclusive_start_id = exclusive_start_id;
    let p_query_limit = limit;
    let p_query_cursor = cursor;
    let p_query_filter = filter;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/request-queue/requests", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if let Some(ref param_value) = p_query_exclusive_start_id {
        req_builder = req_builder.query(&[("exclusiveStartId", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_limit {
        req_builder = req_builder.query(&[("limit", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListOfRequestsResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListOfRequestsResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueRequestsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_requests_post(configuration: &configuration::Configuration, actor_task_id: &str, request_base: models::RequestBase, status: Option<&str>, client_key: Option<&str>, forefront: Option<&str>) -> Result<models::AddRequestResponse, Error<ActorTaskRunsLastRequestQueueRequestsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_body_request_base = request_base;
    let p_query_status = status;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AddRequestResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AddRequestResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueRequestsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_request_queue_requests_unlock_post(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>, client_key: Option<&str>) -> Result<models::UnlockRequestsResponse, Error<ActorTaskRunsLastRequestQueueRequestsUnlockPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;
    let p_query_client_key = client_key;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/request-queue/requests/unlock", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UnlockRequestsResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UnlockRequestsResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastRequestQueueRequestsUnlockPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
