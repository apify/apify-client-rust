...
/// struct for typed errors of method [`key_value_store_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KeyValueStoreDeleteError {
...
/// struct for typed errors of method [`key_value_store_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KeyValueStoreGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`key_value_store_keys_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KeyValueStoreKeysGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`key_value_store_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KeyValueStorePutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`key_value_store_record_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KeyValueStoreRecordDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`key_value_store_record_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KeyValueStoreRecordGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`key_value_store_record_head`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KeyValueStoreRecordHeadError {
    Status404(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`key_value_store_record_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KeyValueStoreRecordPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`key_value_store_record_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KeyValueStoreRecordPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`key_value_store_records_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KeyValueStoreRecordsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`key_value_stores_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KeyValueStoresGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status405(models::ErrorResponse),
...
/// struct for typed errors of method [`key_value_stores_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KeyValueStoresPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status405(models::ErrorResponse),
...
pub async fn key_value_store_delete(configuration: &configuration::Configuration, store_id: &str) -> Result<(), Error<KeyValueStoreDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;

    let uri_str = format!("{}/v2/key-value-stores/{storeId}", configuration.base_path, storeId=crate::apis::urlencode(p_path_store_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<KeyValueStoreDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Gets an object that contains all the details about a specific key-value store. 
pub async fn key_value_store_get(configuration: &configuration::Configuration, store_id: &str) -> Result<models::KeyValueStoreResponse, Error<KeyValueStoreGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::KeyValueStoreResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::KeyValueStoreResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<KeyValueStoreGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn key_value_store_keys_get(configuration: &configuration::Configuration, store_id: &str, exclusive_start_key: Option<&str>, limit: Option<f64>, collection: Option<&str>, prefix: Option<&str>, signature: Option<&str>) -> Result<models::ListOfKeysResponse, Error<KeyValueStoreKeysGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_query_exclusive_start_key = exclusive_start_key;
    let p_query_limit = limit;
    let p_query_collection = collection;
    let p_query_prefix = prefix;
    let p_query_signature = signature;

    let uri_str = format!("{}/v2/key-value-stores/{storeId}/keys", configuration.base_path, storeId=crate::apis::urlencode(p_path_store_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_query_exclusive_start_key {
        req_builder = req_builder.query(&[("exclusiveStartKey", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_limit {
        req_builder = req_builder.query(&[("limit", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_collection {
        req_builder = req_builder.query(&[("collection", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListOfKeysResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListOfKeysResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<KeyValueStoreKeysGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn key_value_store_put(configuration: &configuration::Configuration, store_id: &str, update_store_request: models::UpdateStoreRequest) -> Result<models::KeyValueStoreResponse, Error<KeyValueStorePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KeyValueStorePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Removes a record specified by a key from the key-value store.
pub async fn key_value_store_record_delete(configuration: &configuration::Configuration, store_id: &str, record_key: &str) -> Result<(), Error<KeyValueStoreRecordDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_path_record_key = record_key;

    let uri_str = format!("{}/v2/key-value-stores/{storeId}/records/{recordKey}", configuration.base_path, storeId=crate::apis::urlencode(p_path_store_id), recordKey=crate::apis::urlencode(p_path_record_key));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KeyValueStoreRecordDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn key_value_store_record_get(configuration: &configuration::Configuration, store_id: &str, record_key: &str, attachment: Option<bool>, signature: Option<&str>) -> Result<std::collections::HashMap<String, serde_json::Value>, Error<KeyValueStoreRecordGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_path_record_key = record_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KeyValueStoreRecordGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Check if a value is stored in the key-value store under a specific key. 
pub async fn key_value_store_record_head(configuration: &configuration::Configuration, store_id: &str, record_key: &str) -> Result<(), Error<KeyValueStoreRecordHeadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_path_record_key = record_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KeyValueStoreRecordHeadError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn key_value_store_record_post(configuration: &configuration::Configuration, store_id: &str, record_key: &str, request_body: std::collections::HashMap<String, serde_json::Value>, content_encoding: Option<&str>) -> Result<serde_json::Value, Error<KeyValueStoreRecordPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_path_record_key = record_key;
    let p_body_request_body = request_body;
    let p_header_content_encoding = content_encoding;
    ...
    if let Some(param_value) = p_header_content_encoding {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KeyValueStoreRecordPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn key_value_store_record_put(configuration: &configuration::Configuration, store_id: &str, record_key: &str, request_body: std::collections::HashMap<String, serde_json::Value>, content_encoding: Option<&str>) -> Result<serde_json::Value, Error<KeyValueStoreRecordPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_path_record_key = record_key;
    let p_body_request_body = request_body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KeyValueStoreRecordPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn key_value_store_records_get(configuration: &configuration::Configuration, store_id: &str, collection: Option<&str>, prefix: Option<&str>, signature: Option<&str>) -> Result<reqwest::Response, Error<KeyValueStoreRecordsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_store_id = store_id;
    let p_query_collection = collection;
    let p_query_prefix = prefix;
    ...
    let uri_str = format!("{}/v2/key-value-stores/{storeId}/records", configuration.base_path, storeId=crate::apis::urlencode(p_path_store_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KeyValueStoreRecordsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn key_value_stores_get(configuration: &configuration::Configuration, offset: Option<f64>, limit: Option<f64>, desc: Option<bool>, unnamed: Option<bool>, ownership: Option<models::StorageOwnership>) -> Result<models::ListOfKeyValueStoresResponse, Error<KeyValueStoresGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/v2/key-value-stores", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListOfKeyValueStoresResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListOfKeyValueStoresResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<KeyValueStoresGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn key_value_stores_post(configuration: &configuration::Configuration, name: Option<&str>) -> Result<models::KeyValueStoreResponse, Error<KeyValueStoresPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KeyValueStoresPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
