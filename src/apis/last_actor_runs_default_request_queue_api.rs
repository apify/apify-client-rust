...
/// struct for typed errors of method [`act_runs_last_request_queue_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueDeleteError {
...
/// struct for typed errors of method [`act_runs_last_request_queue_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_head_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueHeadGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_head_lock_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueHeadLockPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueuePutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_request_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueRequestDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_request_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueRequestGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_request_lock_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueRequestLockDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_request_lock_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueRequestLockPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_request_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueRequestPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_requests_batch_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueRequestsBatchDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_requests_batch_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueRequestsBatchPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_requests_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueRequestsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_requests_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueRequestsPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_request_queue_requests_unlock_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastRequestQueueRequestsUnlockPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn act_runs_last_request_queue_delete(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>) -> Result<(), Error<ActRunsLastRequestQueueDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;

    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/request-queue", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ActRunsLastRequestQueueDeleteError> = serde_json::from_str(&content).ok();
...
pub async fn act_runs_last_request_queue_get(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>) -> Result<models::RequestQueueResponse, Error<ActRunsLastRequestQueueGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_head_get(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>, limit: Option<f64>, client_key: Option<&str>) -> Result<models::HeadResponse, Error<ActRunsLastRequestQueueHeadGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;
    ...
    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/request-queue/head", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueHeadGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_head_lock_post(configuration: &configuration::Configuration, actor_id: &str, lock_secs: f64, status: Option<&str>, limit: Option<f64>, client_key: Option<&str>) -> Result<models::HeadAndLockResponse, Error<ActRunsLastRequestQueueHeadLockPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    ...
    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/request-queue/head/lock", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueHeadLockPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_put(configuration: &configuration::Configuration, actor_id: &str, update_request_queue_request: models::UpdateRequestQueueRequest, status: Option<&str>) -> Result<models::RequestQueueResponse, Error<ActRunsLastRequestQueuePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueuePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_request_delete(configuration: &configuration::Configuration, actor_id: &str, request_id: &str, status: Option<&str>, client_key: Option<&str>) -> Result<(), Error<ActRunsLastRequestQueueRequestDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    ...
    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/request-queue/requests/{requestId}", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id), requestId=crate::apis::urlencode(p_path_request_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueRequestDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_request_get(configuration: &configuration::Configuration, actor_id: &str, request_id: &str, status: Option<&str>) -> Result<models::RequestResponse, Error<ActRunsLastRequestQueueRequestGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_request_id = request_id;
    let p_query_status = status;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueRequestGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_request_lock_delete(configuration: &configuration::Configuration, actor_id: &str, request_id: &str, status: Option<&str>, client_key: Option<&str>, forefront: Option<&str>) -> Result<(), Error<ActRunsLastRequestQueueRequestLockDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_request_id = request_id;
    let p_query_status = status;
    ...
    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/request-queue/requests/{requestId}/lock", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id), requestId=crate::apis::urlencode(p_path_request_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueRequestLockDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_request_lock_put(configuration: &configuration::Configuration, actor_id: &str, request_id: &str, lock_secs: f64, status: Option<&str>, client_key: Option<&str>, forefront: Option<&str>) -> Result<models::ProlongRequestLockResponse, Error<ActRunsLastRequestQueueRequestLockPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_request_id = request_id;
    let p_query_lock_secs = lock_secs;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueRequestLockPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_request_put(configuration: &configuration::Configuration, actor_id: &str, request_id: &str, request: models::Request, status: Option<&str>, forefront: Option<&str>, client_key: Option<&str>) -> Result<models::UpdateRequestResponse, Error<ActRunsLastRequestQueueRequestPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_request_id = request_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueRequestPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_requests_batch_delete(configuration: &configuration::Configuration, actor_id: &str, content_type: &str, request_draft_delete: Vec<models::RequestDraftDelete>, status: Option<&str>, client_key: Option<&str>) -> Result<models::BatchDeleteResponse, Error<ActRunsLastRequestQueueRequestsBatchDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    ...
    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/request-queue/requests/batch", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueRequestsBatchDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_requests_batch_post(configuration: &configuration::Configuration, actor_id: &str, request_base: Vec<models::RequestBase>, status: Option<&str>, client_key: Option<&str>, forefront: Option<&str>) -> Result<models::BatchAddResponse, Error<ActRunsLastRequestQueueRequestsBatchPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueRequestsBatchPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_requests_get(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>, client_key: Option<&str>, exclusive_start_id: Option<&str>, limit: Option<f64>, cursor: Option<&str>, filter: Option<Vec<String>>) -> Result<models::ListOfRequestsResponse, Error<ActRunsLastRequestQueueRequestsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;
    let p_query_client_key = client_key;
    ...
    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/request-queue/requests", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueRequestsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_requests_post(configuration: &configuration::Configuration, actor_id: &str, request_base: models::RequestBase, status: Option<&str>, client_key: Option<&str>, forefront: Option<&str>) -> Result<models::AddRequestResponse, Error<ActRunsLastRequestQueueRequestsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_body_request_base = request_base;
    let p_query_status = status;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueRequestsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_request_queue_requests_unlock_post(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>, client_key: Option<&str>) -> Result<models::UnlockRequestsResponse, Error<ActRunsLastRequestQueueRequestsUnlockPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;
    let p_query_client_key = client_key;

    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/request-queue/requests/unlock", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastRequestQueueRequestsUnlockPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
