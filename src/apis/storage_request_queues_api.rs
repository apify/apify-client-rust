...
/// struct for typed errors of method [`request_queue_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueDeleteError {
...
/// struct for typed errors of method [`request_queue_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`request_queue_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueuePutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`request_queue_requests_batch_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueRequestsBatchDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`request_queue_requests_batch_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueRequestsBatchPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`request_queues_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueuesGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status405(models::ErrorResponse),
...
/// struct for typed errors of method [`request_queues_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueuesPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status405(models::ErrorResponse),
...
/// Deletes given queue.
pub async fn request_queue_delete(configuration: &configuration::Configuration, queue_id: &str) -> Result<(), Error<RequestQueueDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;

    let uri_str = format!("{}/v2/request-queues/{queueId}", configuration.base_path, queueId=crate::apis::urlencode(p_path_queue_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<RequestQueueDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns queue object for given queue ID.
pub async fn request_queue_get(configuration: &configuration::Configuration, queue_id: &str) -> Result<models::RequestQueueResponse, Error<RequestQueueGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueueGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn request_queue_put(configuration: &configuration::Configuration, queue_id: &str, update_request_queue_request: models::UpdateRequestQueueRequest) -> Result<models::RequestQueueResponse, Error<RequestQueuePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueuePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn request_queue_requests_batch_delete(configuration: &configuration::Configuration, queue_id: &str, content_type: &str, request_draft_delete: Vec<models::RequestDraftDelete>, client_key: Option<&str>) -> Result<models::BatchDeleteResponse, Error<RequestQueueRequestsBatchDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    ...
    let uri_str = format!("{}/v2/request-queues/{queueId}/requests/batch", configuration.base_path, queueId=crate::apis::urlencode(p_path_queue_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueueRequestsBatchDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn request_queue_requests_batch_post(configuration: &configuration::Configuration, queue_id: &str, request_base: Vec<models::RequestBase>, client_key: Option<&str>, forefront: Option<&str>) -> Result<models::BatchAddResponse, Error<RequestQueueRequestsBatchPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueueRequestsBatchPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn request_queues_get(configuration: &configuration::Configuration, offset: Option<f64>, limit: Option<f64>, desc: Option<bool>, unnamed: Option<bool>, ownership: Option<models::StorageOwnership>) -> Result<models::ListOfRequestQueuesResponse, Error<RequestQueuesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/v2/request-queues", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListOfRequestQueuesResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListOfRequestQueuesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<RequestQueuesGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn request_queues_post(configuration: &configuration::Configuration, name: Option<&str>) -> Result<models::RequestQueueResponse, Error<RequestQueuesPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueuesPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
