...
/// struct for typed errors of method [`actor_run_request_queue_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueDeleteError {
...
/// struct for typed errors of method [`actor_run_request_queue_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_head_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueHeadGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_head_lock_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueHeadLockPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueuePutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_request_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueRequestDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_request_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueRequestGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_request_lock_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueRequestLockDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_request_lock_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueRequestLockPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_request_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueRequestPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_requests_batch_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueRequestsBatchDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_requests_batch_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueRequestsBatchPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_requests_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueRequestsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_requests_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueRequestsPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_request_queue_requests_unlock_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunRequestQueueRequestsUnlockPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn actor_run_request_queue_delete(configuration: &configuration::Configuration, run_id: &str) -> Result<(), Error<ActorRunRequestQueueDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;

    let uri_str = format!("{}/v2/actor-runs/{runId}/request-queue", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ActorRunRequestQueueDeleteError> = serde_json::from_str(&content).ok();
...
pub async fn actor_run_request_queue_get(configuration: &configuration::Configuration, run_id: &str) -> Result<models::RequestQueueResponse, Error<ActorRunRequestQueueGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_head_get(configuration: &configuration::Configuration, run_id: &str, limit: Option<f64>, client_key: Option<&str>) -> Result<models::HeadResponse, Error<ActorRunRequestQueueHeadGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_query_limit = limit;
    let p_query_client_key = client_key;

    let uri_str = format!("{}/v2/actor-runs/{runId}/request-queue/head", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueHeadGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_head_lock_post(configuration: &configuration::Configuration, run_id: &str, lock_secs: f64, limit: Option<f64>, client_key: Option<&str>) -> Result<models::HeadAndLockResponse, Error<ActorRunRequestQueueHeadLockPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    ...
    let uri_str = format!("{}/v2/actor-runs/{runId}/request-queue/head/lock", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueHeadLockPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_put(configuration: &configuration::Configuration, run_id: &str, update_request_queue_request: models::UpdateRequestQueueRequest) -> Result<models::RequestQueueResponse, Error<ActorRunRequestQueuePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueuePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_request_delete(configuration: &configuration::Configuration, run_id: &str, request_id: &str, client_key: Option<&str>) -> Result<(), Error<ActorRunRequestQueueRequestDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_path_request_id = request_id;
    let p_query_client_key = client_key;

    let uri_str = format!("{}/v2/actor-runs/{runId}/request-queue/requests/{requestId}", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id), requestId=crate::apis::urlencode(p_path_request_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueRequestDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_request_get(configuration: &configuration::Configuration, run_id: &str, request_id: &str) -> Result<models::RequestResponse, Error<ActorRunRequestQueueRequestGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_path_request_id = request_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueRequestGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_request_lock_delete(configuration: &configuration::Configuration, run_id: &str, request_id: &str, client_key: Option<&str>, forefront: Option<&str>) -> Result<(), Error<ActorRunRequestQueueRequestLockDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_path_request_id = request_id;
    let p_query_client_key = client_key;
    ...
    let uri_str = format!("{}/v2/actor-runs/{runId}/request-queue/requests/{requestId}/lock", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id), requestId=crate::apis::urlencode(p_path_request_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueRequestLockDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_request_lock_put(configuration: &configuration::Configuration, run_id: &str, request_id: &str, lock_secs: f64, client_key: Option<&str>, forefront: Option<&str>) -> Result<models::ProlongRequestLockResponse, Error<ActorRunRequestQueueRequestLockPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_path_request_id = request_id;
    let p_query_lock_secs = lock_secs;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueRequestLockPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_request_put(configuration: &configuration::Configuration, run_id: &str, request_id: &str, request: models::Request, forefront: Option<&str>, client_key: Option<&str>) -> Result<models::UpdateRequestResponse, Error<ActorRunRequestQueueRequestPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_path_request_id = request_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueRequestPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_requests_batch_delete(configuration: &configuration::Configuration, run_id: &str, content_type: &str, request_draft_delete: Vec<models::RequestDraftDelete>, client_key: Option<&str>) -> Result<models::BatchDeleteResponse, Error<ActorRunRequestQueueRequestsBatchDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    ...
    let uri_str = format!("{}/v2/actor-runs/{runId}/request-queue/requests/batch", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueRequestsBatchDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_requests_batch_post(configuration: &configuration::Configuration, run_id: &str, request_base: Vec<models::RequestBase>, client_key: Option<&str>, forefront: Option<&str>) -> Result<models::BatchAddResponse, Error<ActorRunRequestQueueRequestsBatchPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueRequestsBatchPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_requests_get(configuration: &configuration::Configuration, run_id: &str, client_key: Option<&str>, exclusive_start_id: Option<&str>, limit: Option<f64>, cursor: Option<&str>, filter: Option<Vec<String>>) -> Result<models::ListOfRequestsResponse, Error<ActorRunRequestQueueRequestsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_query_client_key = client_key;
    ...
    let uri_str = format!("{}/v2/actor-runs/{runId}/request-queue/requests", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueRequestsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_requests_post(configuration: &configuration::Configuration, run_id: &str, request_base: models::RequestBase, client_key: Option<&str>, forefront: Option<&str>) -> Result<models::AddRequestResponse, Error<ActorRunRequestQueueRequestsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_body_request_base = request_base;
    let p_query_client_key = client_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueRequestsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_request_queue_requests_unlock_post(configuration: &configuration::Configuration, run_id: &str, client_key: Option<&str>) -> Result<models::UnlockRequestsResponse, Error<ActorRunRequestQueueRequestsUnlockPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_query_client_key = client_key;

    let uri_str = format!("{}/v2/actor-runs/{runId}/request-queue/requests/unlock", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunRequestQueueRequestsUnlockPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
