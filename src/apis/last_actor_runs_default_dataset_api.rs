...
/// struct for typed errors of method [`act_runs_last_dataset_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastDatasetDeleteError {
...
/// struct for typed errors of method [`act_runs_last_dataset_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastDatasetGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_dataset_items_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastDatasetItemsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_dataset_items_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastDatasetItemsPostError {
...
/// struct for typed errors of method [`act_runs_last_dataset_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastDatasetPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_dataset_statistics_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastDatasetStatisticsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn act_runs_last_dataset_delete(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>) -> Result<(), Error<ActRunsLastDatasetDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;

    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/dataset", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ActRunsLastDatasetDeleteError> = serde_json::from_str(&content).ok();
...
pub async fn act_runs_last_dataset_get(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>) -> Result<models::DatasetResponse, Error<ActRunsLastDatasetGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastDatasetGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_dataset_items_get(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>, format: Option<&str>, clean: Option<bool>, offset: Option<f64>, limit: Option<f64>, fields: Option<&str>, output_fields: Option<&str>, omit: Option<&str>, unwind: Option<&str>, flatten: Option<&str>, desc: Option<bool>, attachment: Option<bool>, delimiter: Option<&str>, bom: Option<bool>, xml_root: Option<&str>, xml_row: Option<&str>, skip_header_row: Option<bool>, skip_hidden: Option<bool>, skip_empty: Option<bool>, simplified: Option<bool>, view: Option<&str>, skip_failed_pages: Option<bool>, feed_title: Option<&str>, feed_description: Option<&str>, signature: Option<&str>) -> Result<Vec<serde_json::Value>, Error<ActRunsLastDatasetItemsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;
    ...
    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/dataset/items", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastDatasetItemsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_dataset_items_post(configuration: &configuration::Configuration, actor_id: &str, act_runs_last_dataset_items_post_request: Option<models::ActRunsLastDatasetItemsPostRequest>, status: Option<&str>) -> Result<serde_json::Value, Error<ActRunsLastDatasetItemsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastDatasetItemsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_dataset_put(configuration: &configuration::Configuration, actor_id: &str, update_dataset_request: models::UpdateDatasetRequest, status: Option<&str>) -> Result<models::DatasetResponse, Error<ActRunsLastDatasetPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastDatasetPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_dataset_statistics_get(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>) -> Result<models::DatasetStatisticsResponse, Error<ActRunsLastDatasetStatisticsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;

    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/dataset/statistics", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastDatasetStatisticsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
