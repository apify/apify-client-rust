...
/// struct for typed errors of method [`act_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActDeleteError {
...
/// struct for typed errors of method [`act_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_validate_input_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActValidateInputPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`acts_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status405(models::ErrorResponse),
...
/// struct for typed errors of method [`acts_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActsPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status405(models::ErrorResponse),
...
/// Deletes an Actor.
pub async fn act_delete(configuration: &configuration::Configuration, actor_id: &str) -> Result<serde_json::Value, Error<ActDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;

    let uri_str = format!("{}/v2/actors/{actorId}", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Gets an object that contains all the details about a specific Actor.
pub async fn act_get(configuration: &configuration::Configuration, actor_id: &str) -> Result<models::ActorResponse, Error<ActGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ActorResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ActorResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_put(configuration: &configuration::Configuration, actor_id: &str, update_actor_request: models::UpdateActorRequest) -> Result<models::ActorResponse, Error<ActPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_body_update_actor_request = update_actor_request;
    ...
    req_builder = req_builder.json(&p_body_update_actor_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_validate_input_post(configuration: &configuration::Configuration, actor_id: &str, body: serde_json::Value, build: Option<&str>) -> Result<models::ActValidateInputPost200Response, Error<ActValidateInputPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_body_body = body;
    let p_query_build = build;

    let uri_str = format!("{}/v2/actors/{actorId}/validate-input", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ActValidateInputPost200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ActValidateInputPost200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActValidateInputPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn acts_get(configuration: &configuration::Configuration, my: Option<bool>, offset: Option<f64>, limit: Option<f64>, desc: Option<bool>, sort_by: Option<&str>) -> Result<models::ListOfActorsResponse, Error<ActsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_my = my;
    ...
    let uri_str = format!("{}/v2/actors", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_query_my {
        req_builder = req_builder.query(&[("my", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListOfActorsResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListOfActorsResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn acts_post(configuration: &configuration::Configuration, create_actor_request: models::CreateActorRequest) -> Result<models::ActorResponse, Error<ActsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_create_actor_request = create_actor_request;
    ...
    req_builder = req_builder.json(&p_body_create_actor_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
