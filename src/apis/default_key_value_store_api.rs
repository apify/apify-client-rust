...
/// struct for typed errors of method [`actor_run_key_value_store_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunKeyValueStoreDeleteError {
...
/// struct for typed errors of method [`actor_run_key_value_store_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunKeyValueStoreGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_key_value_store_keys_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunKeyValueStoreKeysGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_key_value_store_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunKeyValueStorePutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_key_value_store_record_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunKeyValueStoreRecordDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_key_value_store_record_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunKeyValueStoreRecordGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_key_value_store_record_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunKeyValueStoreRecordPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_key_value_store_record_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunKeyValueStoreRecordPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_key_value_store_records_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunKeyValueStoreRecordsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn actor_run_key_value_store_delete(configuration: &configuration::Configuration, run_id: &str) -> Result<(), Error<ActorRunKeyValueStoreDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;

    let uri_str = format!("{}/v2/actor-runs/{runId}/key-value-store", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ActorRunKeyValueStoreDeleteError> = serde_json::from_str(&content).ok();
...
pub async fn actor_run_key_value_store_get(configuration: &configuration::Configuration, run_id: &str) -> Result<models::KeyValueStoreResponse, Error<ActorRunKeyValueStoreGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunKeyValueStoreGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_key_value_store_keys_get(configuration: &configuration::Configuration, run_id: &str, exclusive_start_key: Option<&str>, limit: Option<f64>, collection: Option<&str>, prefix: Option<&str>, signature: Option<&str>) -> Result<models::ListOfKeysResponse, Error<ActorRunKeyValueStoreKeysGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    ...
    let uri_str = format!("{}/v2/actor-runs/{runId}/key-value-store/keys", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunKeyValueStoreKeysGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_key_value_store_put(configuration: &configuration::Configuration, run_id: &str, update_store_request: models::UpdateStoreRequest) -> Result<models::KeyValueStoreResponse, Error<ActorRunKeyValueStorePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunKeyValueStorePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_key_value_store_record_delete(configuration: &configuration::Configuration, run_id: &str, record_key: &str) -> Result<(), Error<ActorRunKeyValueStoreRecordDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_path_record_key = record_key;

    let uri_str = format!("{}/v2/actor-runs/{runId}/key-value-store/records/{recordKey}", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id), recordKey=crate::apis::urlencode(p_path_record_key));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunKeyValueStoreRecordDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_key_value_store_record_get(configuration: &configuration::Configuration, run_id: &str, record_key: &str, signature: Option<&str>, attachment: Option<bool>) -> Result<std::collections::HashMap<String, serde_json::Value>, Error<ActorRunKeyValueStoreRecordGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_path_record_key = record_key;
    let p_query_signature = signature;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunKeyValueStoreRecordGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_key_value_store_record_post(configuration: &configuration::Configuration, run_id: &str, record_key: &str, request_body: std::collections::HashMap<String, serde_json::Value>, content_encoding: Option<&str>) -> Result<serde_json::Value, Error<ActorRunKeyValueStoreRecordPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_path_record_key = record_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunKeyValueStoreRecordPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_key_value_store_record_put(configuration: &configuration::Configuration, run_id: &str, record_key: &str, request_body: std::collections::HashMap<String, serde_json::Value>, content_encoding: Option<&str>) -> Result<serde_json::Value, Error<ActorRunKeyValueStoreRecordPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_path_record_key = record_key;
    let p_body_request_body = request_body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunKeyValueStoreRecordPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_key_value_store_records_get(configuration: &configuration::Configuration, run_id: &str, collection: Option<&str>, prefix: Option<&str>, signature: Option<&str>) -> Result<reqwest::Response, Error<ActorRunKeyValueStoreRecordsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    let p_query_collection = collection;
    let p_query_prefix = prefix;
    ...
    let uri_str = format!("{}/v2/actor-runs/{runId}/key-value-store/records", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunKeyValueStoreRecordsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
