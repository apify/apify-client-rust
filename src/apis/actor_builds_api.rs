...
/// struct for typed errors of method [`actor_build_abort_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorBuildAbortPostError {
...
/// struct for typed errors of method [`actor_build_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorBuildDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_build_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorBuildGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_build_log_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorBuildLogGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_build_openapi_json_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorBuildOpenapiJsonGetError {
    Status400(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status405(models::ErrorResponse),
    Status429(models::ErrorResponse),
...
pub async fn actor_build_abort_post(configuration: &configuration::Configuration, build_id: &str) -> Result<models::BuildResponse, Error<ActorBuildAbortPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_build_id = build_id;

    let uri_str = format!("{}/v2/actor-builds/{buildId}/abort", configuration.base_path, buildId=crate::apis::urlencode(p_path_build_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorBuildAbortPostError> = serde_json::from_str(&content).ok();
...
pub async fn actor_build_delete(configuration: &configuration::Configuration, build_id: &str) -> Result<(), Error<ActorBuildDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_build_id = build_id;

    let uri_str = format!("{}/v2/actor-builds/{buildId}", configuration.base_path, buildId=crate::apis::urlencode(p_path_build_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorBuildDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_build_get(configuration: &configuration::Configuration, build_id: &str, wait_for_finish: Option<f64>) -> Result<models::BuildResponse, Error<ActorBuildGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_build_id = build_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorBuildGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_build_log_get(configuration: &configuration::Configuration, build_id: &str, stream: Option<bool>, download: Option<bool>) -> Result<String, Error<ActorBuildLogGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_build_id = build_id;
    let p_query_stream = stream;
    let p_query_download = download;

    let uri_str = format!("{}/v2/actor-builds/{buildId}/log", configuration.base_path, buildId=crate::apis::urlencode(p_path_build_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorBuildLogGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_build_openapi_json_get(configuration: &configuration::Configuration, build_id: &str) -> Result<serde_json::Value, Error<ActorBuildOpenapiJsonGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_build_id = build_id;

    let uri_str = format!("{}/v2/actor-builds/{buildId}/openapi.json", configuration.base_path, buildId=crate::apis::urlencode(p_path_build_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorBuildOpenapiJsonGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_builds_get(configuration: &configuration::Configuration, offset: Option<f64>, limit: Option<f64>, desc: Option<bool>) -> Result<models::ListOfBuildsResponse, Error<ActorBuildsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_desc = desc;

    let uri_str = format!("{}/v2/actor-builds", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorBuildsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
