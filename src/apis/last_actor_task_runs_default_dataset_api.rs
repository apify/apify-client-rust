...
/// struct for typed errors of method [`actor_task_runs_last_dataset_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastDatasetDeleteError {
...
/// struct for typed errors of method [`actor_task_runs_last_dataset_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastDatasetGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_dataset_items_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastDatasetItemsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_dataset_items_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastDatasetItemsPostError {
...
/// struct for typed errors of method [`actor_task_runs_last_dataset_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastDatasetPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_dataset_statistics_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastDatasetStatisticsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn actor_task_runs_last_dataset_delete(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>) -> Result<(), Error<ActorTaskRunsLastDatasetDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/dataset", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ActorTaskRunsLastDatasetDeleteError> = serde_json::from_str(&content).ok();
...
pub async fn actor_task_runs_last_dataset_get(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>) -> Result<models::DatasetResponse, Error<ActorTaskRunsLastDatasetGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastDatasetGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_dataset_items_get(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>, format: Option<&str>, clean: Option<bool>, offset: Option<f64>, limit: Option<f64>, fields: Option<&str>, output_fields: Option<&str>, omit: Option<&str>, unwind: Option<&str>, flatten: Option<&str>, desc: Option<bool>, attachment: Option<bool>, delimiter: Option<&str>, bom: Option<bool>, xml_root: Option<&str>, xml_row: Option<&str>, skip_header_row: Option<bool>, skip_hidden: Option<bool>, skip_empty: Option<bool>, simplified: Option<bool>, view: Option<&str>, skip_failed_pages: Option<bool>, feed_title: Option<&str>, feed_description: Option<&str>, signature: Option<&str>) -> Result<Vec<serde_json::Value>, Error<ActorTaskRunsLastDatasetItemsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;
    ...
    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/dataset/items", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastDatasetItemsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_dataset_items_post(configuration: &configuration::Configuration, actor_task_id: &str, act_runs_last_dataset_items_post_request: Option<models::ActRunsLastDatasetItemsPostRequest>, status: Option<&str>) -> Result<serde_json::Value, Error<ActorTaskRunsLastDatasetItemsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastDatasetItemsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_dataset_put(configuration: &configuration::Configuration, actor_task_id: &str, update_dataset_request: models::UpdateDatasetRequest, status: Option<&str>) -> Result<models::DatasetResponse, Error<ActorTaskRunsLastDatasetPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastDatasetPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_dataset_statistics_get(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>) -> Result<models::DatasetStatisticsResponse, Error<ActorTaskRunsLastDatasetStatisticsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/dataset/statistics", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastDatasetStatisticsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
