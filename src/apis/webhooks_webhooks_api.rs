...
/// struct for typed errors of method [`webhook_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum WebhookGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`webhook_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum WebhookPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`webhook_test_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum WebhookTestPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`webhook_webhook_dispatches_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum WebhookWebhookDispatchesGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// Deletes a webhook.
pub async fn webhook_delete(configuration: &configuration::Configuration, webhook_id: &str) -> Result<serde_json::Value, Error<WebhookDeleteError>> {
...
pub async fn webhook_get(configuration: &configuration::Configuration, webhook_id: &str) -> Result<models::WebhookResponse, Error<WebhookGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_webhook_id = webhook_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<WebhookGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn webhook_put(configuration: &configuration::Configuration, webhook_id: &str, webhook_update: models::WebhookUpdate) -> Result<models::WebhookResponse, Error<WebhookPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_webhook_id = webhook_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<WebhookPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Tests a webhook. Creates a webhook dispatch with a dummy payload.
pub async fn webhook_test_post(configuration: &configuration::Configuration, webhook_id: &str) -> Result<models::TestWebhookResponse, Error<WebhookTestPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_webhook_id = webhook_id;

    let uri_str = format!("{}/v2/webhooks/{webhookId}/test", configuration.base_path, webhookId=crate::apis::urlencode(p_path_webhook_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<WebhookTestPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Gets a given webhook's list of dispatches.
pub async fn webhook_webhook_dispatches_get(configuration: &configuration::Configuration, webhook_id: &str) -> Result<models::ListOfWebhookDispatchesResponse, Error<WebhookWebhookDispatchesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_webhook_id = webhook_id;

    let uri_str = format!("{}/v2/webhooks/{webhookId}/dispatches", configuration.base_path, webhookId=crate::apis::urlencode(p_path_webhook_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListOfWebhookDispatchesResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListOfWebhookDispatchesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<WebhookWebhookDispatchesGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn webhooks_get(configuration: &configuration::Configuration, offset: Option<f64>, limit: Option<f64>, desc: Option<bool>) -> Result<models::ListOfWebhooksResponse, Error<WebhooksGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListOfWebhooksResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListOfWebhooksResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn webhooks_post(configuration: &configuration::Configuration, webhook_create: models::WebhookCreate) -> Result<models::WebhookResponse, Error<WebhooksPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
