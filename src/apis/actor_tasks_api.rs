...
/// struct for typed errors of method [`actor_task_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskDeleteError {
...
/// struct for typed errors of method [`actor_task_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_input_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskInputGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_input_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskInputPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_run_sync_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunSyncGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_run_sync_get_dataset_items_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunSyncGetDatasetItemsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_run_sync_get_dataset_items_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunSyncGetDatasetItemsPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_run_sync_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunSyncPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_webhooks_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskWebhooksGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_tasks_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTasksGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status405(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_tasks_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTasksPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status405(models::ErrorResponse),
...
pub async fn actor_task_delete(configuration: &configuration::Configuration, actor_task_id: &str) -> Result<serde_json::Value, Error<ActorTaskDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get an object that contains all the details about a task.
pub async fn actor_task_get(configuration: &configuration::Configuration, actor_task_id: &str) -> Result<models::ActorTaskGet200Response, Error<ActorTaskGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ActorTaskGet200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ActorTaskGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns the input of a given task.
pub async fn actor_task_input_get(configuration: &configuration::Configuration, actor_task_id: &str) -> Result<serde_json::Value, Error<ActorTaskInputGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/input", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskInputGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_input_put(configuration: &configuration::Configuration, actor_task_id: &str, body: serde_json::Value) -> Result<serde_json::Value, Error<ActorTaskInputPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskInputPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_put(configuration: &configuration::Configuration, actor_task_id: &str, update_task_request: models::UpdateTaskRequest) -> Result<models::ActorTaskGet200Response, Error<ActorTaskPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_run_sync_get(configuration: &configuration::Configuration, actor_task_id: &str, timeout: Option<f64>, memory: Option<f64>, max_items: Option<f64>, build: Option<&str>, output_record_key: Option<&str>, webhooks: Option<&str>) -> Result<serde_json::Value, Error<ActorTaskRunSyncGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    ...
    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/run-sync", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunSyncGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_run_sync_get_dataset_items_get(configuration: &configuration::Configuration, actor_task_id: &str, timeout: Option<f64>, memory: Option<f64>, max_items: Option<f64>, build: Option<&str>, webhooks: Option<&str>, format: Option<&str>, clean: Option<bool>, offset: Option<f64>, limit: Option<f64>, fields: Option<&str>, output_fields: Option<&str>, omit: Option<&str>, unwind: Option<&str>, flatten: Option<&str>, desc: Option<bool>, attachment: Option<bool>, delimiter: Option<&str>, bom: Option<bool>, xml_root: Option<&str>, xml_row: Option<&str>, skip_header_row: Option<bool>, skip_hidden: Option<bool>, skip_empty: Option<bool>, simplified: Option<bool>, view: Option<&str>, skip_failed_pages: Option<bool>, feed_title: Option<&str>, feed_description: Option<&str>) -> Result<serde_json::Value, Error<ActorTaskRunSyncGetDatasetItemsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_timeout = timeout;
    let p_query_memory = memory;
    ...
    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/run-sync-get-dataset-items", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunSyncGetDatasetItemsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_run_sync_get_dataset_items_post(configuration: &configuration::Configuration, actor_task_id: &str, body: serde_json::Value, timeout: Option<f64>, memory: Option<f64>, max_items: Option<f64>, max_total_charge_usd: Option<f64>, restart_on_error: Option<bool>, build: Option<&str>, webhooks: Option<&str>, format: Option<&str>, clean: Option<bool>, offset: Option<f64>, limit: Option<f64>, fields: Option<&str>, output_fields: Option<&str>, omit: Option<&str>, unwind: Option<&str>, flatten: Option<&str>, desc: Option<bool>, attachment: Option<bool>, delimiter: Option<&str>, bom: Option<bool>, xml_root: Option<&str>, xml_row: Option<&str>, skip_header_row: Option<bool>, skip_hidden: Option<bool>, skip_empty: Option<bool>, simplified: Option<bool>, view: Option<&str>, skip_failed_pages: Option<bool>, feed_title: Option<&str>, feed_description: Option<&str>) -> Result<serde_json::Value, Error<ActorTaskRunSyncGetDatasetItemsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_body_body = body;
    let p_query_timeout = timeout;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunSyncGetDatasetItemsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_run_sync_post(configuration: &configuration::Configuration, actor_task_id: &str, body: serde_json::Value, timeout: Option<f64>, memory: Option<f64>, max_items: Option<f64>, max_total_charge_usd: Option<f64>, restart_on_error: Option<bool>, build: Option<&str>, output_record_key: Option<&str>, webhooks: Option<&str>) -> Result<serde_json::Value, Error<ActorTaskRunSyncPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_body_body = body;
    let p_query_timeout = timeout;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunSyncPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_get(configuration: &configuration::Configuration, actor_task_id: &str, offset: Option<f64>, limit: Option<f64>, desc: Option<bool>, status: Option<Vec<String>>) -> Result<models::ActorTaskRunsGet200Response, Error<ActorTaskRunsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_offset = offset;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ActorTaskRunsGet200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ActorTaskRunsGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_get(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>, wait_for_finish: Option<f64>) -> Result<models::ActorTaskRunsPost201Response, Error<ActorTaskRunsLastGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;
    let p_query_wait_for_finish = wait_for_finish;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ActorTaskRunsPost201Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ActorTaskRunsPost201Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_post(configuration: &configuration::Configuration, actor_task_id: &str, body: serde_json::Value, timeout: Option<f64>, memory: Option<f64>, max_items: Option<f64>, max_total_charge_usd: Option<f64>, restart_on_error: Option<bool>, build: Option<&str>, wait_for_finish: Option<f64>, webhooks: Option<&str>) -> Result<models::ActorTaskRunsPost201Response, Error<ActorTaskRunsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_body_body = body;
    let p_query_timeout = timeout;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_webhooks_get(configuration: &configuration::Configuration, actor_task_id: &str, offset: Option<f64>, limit: Option<f64>, desc: Option<bool>) -> Result<models::ActorTaskWebhooksGet200Response, Error<ActorTaskWebhooksGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_offset = offset;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/webhooks", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ActorTaskWebhooksGet200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ActorTaskWebhooksGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTaskWebhooksGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_tasks_get(configuration: &configuration::Configuration, offset: Option<f64>, limit: Option<f64>, desc: Option<bool>) -> Result<models::ListOfTasksResponse, Error<ActorTasksGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_desc = desc;

    let uri_str = format!("{}/v2/actor-tasks", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListOfTasksResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListOfTasksResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActorTasksGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_tasks_post(configuration: &configuration::Configuration, create_task_request: models::CreateTaskRequest) -> Result<models::TaskResponse, Error<ActorTasksPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTasksPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
