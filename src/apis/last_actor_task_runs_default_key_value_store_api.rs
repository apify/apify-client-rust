...
/// struct for typed errors of method [`actor_task_runs_last_key_value_store_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastKeyValueStoreDeleteError {
...
/// struct for typed errors of method [`actor_task_runs_last_key_value_store_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastKeyValueStoreGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_key_value_store_keys_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastKeyValueStoreKeysGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_key_value_store_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastKeyValueStorePutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_key_value_store_record_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastKeyValueStoreRecordDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_key_value_store_record_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastKeyValueStoreRecordGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_key_value_store_record_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastKeyValueStoreRecordPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_key_value_store_record_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastKeyValueStoreRecordPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_task_runs_last_key_value_store_records_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorTaskRunsLastKeyValueStoreRecordsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn actor_task_runs_last_key_value_store_delete(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>) -> Result<(), Error<ActorTaskRunsLastKeyValueStoreDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/key-value-store", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ActorTaskRunsLastKeyValueStoreDeleteError> = serde_json::from_str(&content).ok();
...
pub async fn actor_task_runs_last_key_value_store_get(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>) -> Result<models::KeyValueStoreResponse, Error<ActorTaskRunsLastKeyValueStoreGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastKeyValueStoreGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_key_value_store_keys_get(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>, exclusive_start_key: Option<&str>, limit: Option<f64>, collection: Option<&str>, prefix: Option<&str>, signature: Option<&str>) -> Result<models::ListOfKeysResponse, Error<ActorTaskRunsLastKeyValueStoreKeysGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;
    ...
    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/key-value-store/keys", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastKeyValueStoreKeysGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_key_value_store_put(configuration: &configuration::Configuration, actor_task_id: &str, update_store_request: models::UpdateStoreRequest, status: Option<&str>) -> Result<models::KeyValueStoreResponse, Error<ActorTaskRunsLastKeyValueStorePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastKeyValueStorePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_key_value_store_record_delete(configuration: &configuration::Configuration, actor_task_id: &str, record_key: &str, status: Option<&str>) -> Result<(), Error<ActorTaskRunsLastKeyValueStoreRecordDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_path_record_key = record_key;
    let p_query_status = status;

    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/key-value-store/records/{recordKey}", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id), recordKey=crate::apis::urlencode(p_path_record_key));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastKeyValueStoreRecordDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_key_value_store_record_get(configuration: &configuration::Configuration, actor_task_id: &str, record_key: &str, status: Option<&str>, signature: Option<&str>, attachment: Option<bool>) -> Result<std::collections::HashMap<String, serde_json::Value>, Error<ActorTaskRunsLastKeyValueStoreRecordGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_path_record_key = record_key;
    let p_query_status = status;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastKeyValueStoreRecordGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_key_value_store_record_post(configuration: &configuration::Configuration, actor_task_id: &str, record_key: &str, request_body: std::collections::HashMap<String, serde_json::Value>, status: Option<&str>, content_encoding: Option<&str>) -> Result<serde_json::Value, Error<ActorTaskRunsLastKeyValueStoreRecordPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_path_record_key = record_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastKeyValueStoreRecordPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_key_value_store_record_put(configuration: &configuration::Configuration, actor_task_id: &str, record_key: &str, request_body: std::collections::HashMap<String, serde_json::Value>, status: Option<&str>, content_encoding: Option<&str>) -> Result<serde_json::Value, Error<ActorTaskRunsLastKeyValueStoreRecordPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_path_record_key = record_key;
    let p_body_request_body = request_body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastKeyValueStoreRecordPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_task_runs_last_key_value_store_records_get(configuration: &configuration::Configuration, actor_task_id: &str, status: Option<&str>, collection: Option<&str>, prefix: Option<&str>, signature: Option<&str>) -> Result<reqwest::Response, Error<ActorTaskRunsLastKeyValueStoreRecordsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_task_id = actor_task_id;
    let p_query_status = status;
    let p_query_collection = collection;
    ...
    let uri_str = format!("{}/v2/actor-tasks/{actorTaskId}/runs/last/key-value-store/records", configuration.base_path, actorTaskId=crate::apis::urlencode(p_path_actor_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorTaskRunsLastKeyValueStoreRecordsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
