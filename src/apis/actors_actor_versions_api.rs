...
/// struct for typed errors of method [`act_version_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActVersionDeleteError {
...
/// struct for typed errors of method [`act_version_env_var_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActVersionEnvVarDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_version_env_var_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActVersionEnvVarGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_version_env_var_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActVersionEnvVarPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_version_env_var_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActVersionEnvVarPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_version_env_vars_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActVersionEnvVarsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_version_env_vars_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActVersionEnvVarsPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_version_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActVersionGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_version_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActVersionPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_version_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActVersionPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_versions_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActVersionsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_versions_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActVersionsPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn act_version_delete(configuration: &configuration::Configuration, actor_id: &str, version_number: &str) -> Result<serde_json::Value, Error<ActVersionDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_version_number = version_number;

    let uri_str = format!("{}/v2/actors/{actorId}/versions/{versionNumber}", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id), versionNumber=crate::apis::urlencode(p_path_version_number));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActVersionDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Deletes a specific environment variable.
pub async fn act_version_env_var_delete(configuration: &configuration::Configuration, actor_id: &str, version_number: &str, env_var_name: &str) -> Result<serde_json::Value, Error<ActVersionEnvVarDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_version_number = version_number;
    let p_path_env_var_name = env_var_name;

    let uri_str = format!("{}/v2/actors/{actorId}/versions/{versionNumber}/env-vars/{envVarName}", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id), versionNumber=crate::apis::urlencode(p_path_version_number), envVarName=crate::apis::urlencode(p_path_env_var_name));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActVersionEnvVarDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_version_env_var_get(configuration: &configuration::Configuration, actor_id: &str, version_number: &str, env_var_name: &str) -> Result<models::EnvVarResponse, Error<ActVersionEnvVarGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_version_number = version_number;
    let p_path_env_var_name = env_var_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::EnvVarResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::EnvVarResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActVersionEnvVarGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_version_env_var_post(configuration: &configuration::Configuration, actor_id: &str, version_number: &str, env_var_name: &str, env_var_request: models::EnvVarRequest) -> Result<models::EnvVarResponse, Error<ActVersionEnvVarPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_version_number = version_number;
    let p_path_env_var_name = env_var_name;
    let p_body_env_var_request = env_var_request;
    ...
    req_builder = req_builder.json(&p_body_env_var_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActVersionEnvVarPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_version_env_var_put(configuration: &configuration::Configuration, actor_id: &str, version_number: &str, env_var_name: &str, env_var_request: models::EnvVarRequest) -> Result<models::EnvVarResponse, Error<ActVersionEnvVarPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_version_number = version_number;
    let p_path_env_var_name = env_var_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActVersionEnvVarPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_version_env_vars_get(configuration: &configuration::Configuration, actor_id: &str, version_number: &str) -> Result<models::ListOfEnvVarsResponse, Error<ActVersionEnvVarsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_version_number = version_number;

    let uri_str = format!("{}/v2/actors/{actorId}/versions/{versionNumber}/env-vars", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id), versionNumber=crate::apis::urlencode(p_path_version_number));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListOfEnvVarsResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListOfEnvVarsResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActVersionEnvVarsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_version_env_vars_post(configuration: &configuration::Configuration, actor_id: &str, version_number: &str, env_var_request: models::EnvVarRequest) -> Result<models::EnvVarResponse, Error<ActVersionEnvVarsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_version_number = version_number;
    let p_body_env_var_request = env_var_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActVersionEnvVarsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Gets a [Version object](#/reference/actors/version-object) that contains all the details about a specific version of an Actor. 
pub async fn act_version_get(configuration: &configuration::Configuration, actor_id: &str, version_number: &str) -> Result<models::VersionResponse, Error<ActVersionGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_version_number = version_number;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActVersionGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_version_post(configuration: &configuration::Configuration, actor_id: &str, version_number: &str, create_or_update_version_request: models::CreateOrUpdateVersionRequest) -> Result<models::VersionResponse, Error<ActVersionPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_version_number = version_number;
    let p_body_create_or_update_version_request = create_or_update_version_request;
    ...
    req_builder = req_builder.json(&p_body_create_or_update_version_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActVersionPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_version_put(configuration: &configuration::Configuration, actor_id: &str, version_number: &str, create_or_update_version_request: models::CreateOrUpdateVersionRequest) -> Result<models::VersionResponse, Error<ActVersionPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_version_number = version_number;
    let p_body_create_or_update_version_request = create_or_update_version_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActVersionPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_versions_get(configuration: &configuration::Configuration, actor_id: &str) -> Result<models::ListOfVersionsResponse, Error<ActVersionsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;

    let uri_str = format!("{}/v2/actors/{actorId}/versions", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListOfVersionsResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListOfVersionsResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActVersionsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_versions_post(configuration: &configuration::Configuration, actor_id: &str, create_or_update_version_request: models::CreateOrUpdateVersionRequest) -> Result<models::VersionResponse, Error<ActVersionsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_body_create_or_update_version_request = create_or_update_version_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActVersionsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
