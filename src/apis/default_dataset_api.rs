...
/// struct for typed errors of method [`actor_run_dataset_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunDatasetDeleteError {
...
/// struct for typed errors of method [`actor_run_dataset_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunDatasetGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_dataset_items_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunDatasetItemsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_dataset_items_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunDatasetItemsPostError {
...
/// struct for typed errors of method [`actor_run_dataset_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunDatasetPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`actor_run_dataset_statistics_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorRunDatasetStatisticsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn actor_run_dataset_delete(configuration: &configuration::Configuration, run_id: &str) -> Result<(), Error<ActorRunDatasetDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;

    let uri_str = format!("{}/v2/actor-runs/{runId}/dataset", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ActorRunDatasetDeleteError> = serde_json::from_str(&content).ok();
...
pub async fn actor_run_dataset_get(configuration: &configuration::Configuration, run_id: &str) -> Result<models::DatasetResponse, Error<ActorRunDatasetGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunDatasetGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_dataset_items_get(configuration: &configuration::Configuration, run_id: &str, format: Option<&str>, clean: Option<bool>, offset: Option<f64>, limit: Option<f64>, fields: Option<&str>, output_fields: Option<&str>, omit: Option<&str>, unwind: Option<&str>, flatten: Option<&str>, desc: Option<bool>, attachment: Option<bool>, delimiter: Option<&str>, bom: Option<bool>, xml_root: Option<&str>, xml_row: Option<&str>, skip_header_row: Option<bool>, skip_hidden: Option<bool>, skip_empty: Option<bool>, simplified: Option<bool>, view: Option<&str>, skip_failed_pages: Option<bool>, feed_title: Option<&str>, feed_description: Option<&str>, signature: Option<&str>) -> Result<Vec<serde_json::Value>, Error<ActorRunDatasetItemsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    ...
    let uri_str = format!("{}/v2/actor-runs/{runId}/dataset/items", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunDatasetItemsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_dataset_items_post(configuration: &configuration::Configuration, run_id: &str, act_runs_last_dataset_items_post_request: Option<models::ActRunsLastDatasetItemsPostRequest>) -> Result<serde_json::Value, Error<ActorRunDatasetItemsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunDatasetItemsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_dataset_put(configuration: &configuration::Configuration, run_id: &str, update_dataset_request: models::UpdateDatasetRequest) -> Result<models::DatasetResponse, Error<ActorRunDatasetPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunDatasetPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn actor_run_dataset_statistics_get(configuration: &configuration::Configuration, run_id: &str) -> Result<models::DatasetStatisticsResponse, Error<ActorRunDatasetStatisticsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_run_id = run_id;

    let uri_str = format!("{}/v2/actor-runs/{runId}/dataset/statistics", configuration.base_path, runId=crate::apis::urlencode(p_path_run_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActorRunDatasetStatisticsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
