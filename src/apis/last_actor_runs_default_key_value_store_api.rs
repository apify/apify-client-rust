...
/// struct for typed errors of method [`act_runs_last_key_value_store_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastKeyValueStoreDeleteError {
...
/// struct for typed errors of method [`act_runs_last_key_value_store_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastKeyValueStoreGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_key_value_store_keys_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastKeyValueStoreKeysGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_key_value_store_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastKeyValueStorePutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_key_value_store_record_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastKeyValueStoreRecordDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_key_value_store_record_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastKeyValueStoreRecordGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_key_value_store_record_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastKeyValueStoreRecordPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_key_value_store_record_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastKeyValueStoreRecordPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`act_runs_last_key_value_store_records_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActRunsLastKeyValueStoreRecordsGetError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn act_runs_last_key_value_store_delete(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>) -> Result<(), Error<ActRunsLastKeyValueStoreDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;

    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/key-value-store", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ActRunsLastKeyValueStoreDeleteError> = serde_json::from_str(&content).ok();
...
pub async fn act_runs_last_key_value_store_get(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>) -> Result<models::KeyValueStoreResponse, Error<ActRunsLastKeyValueStoreGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastKeyValueStoreGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_key_value_store_keys_get(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>, exclusive_start_key: Option<&str>, limit: Option<f64>, collection: Option<&str>, prefix: Option<&str>, signature: Option<&str>) -> Result<models::ListOfKeysResponse, Error<ActRunsLastKeyValueStoreKeysGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;
    ...
    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/key-value-store/keys", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastKeyValueStoreKeysGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_key_value_store_put(configuration: &configuration::Configuration, actor_id: &str, update_store_request: models::UpdateStoreRequest, status: Option<&str>) -> Result<models::KeyValueStoreResponse, Error<ActRunsLastKeyValueStorePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastKeyValueStorePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_key_value_store_record_delete(configuration: &configuration::Configuration, actor_id: &str, record_key: &str, status: Option<&str>) -> Result<(), Error<ActRunsLastKeyValueStoreRecordDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_record_key = record_key;
    let p_query_status = status;

    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/key-value-store/records/{recordKey}", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id), recordKey=crate::apis::urlencode(p_path_record_key));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastKeyValueStoreRecordDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_key_value_store_record_get(configuration: &configuration::Configuration, actor_id: &str, record_key: &str, status: Option<&str>, signature: Option<&str>, attachment: Option<bool>) -> Result<std::collections::HashMap<String, serde_json::Value>, Error<ActRunsLastKeyValueStoreRecordGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_record_key = record_key;
    let p_query_status = status;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastKeyValueStoreRecordGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_key_value_store_record_post(configuration: &configuration::Configuration, actor_id: &str, record_key: &str, request_body: std::collections::HashMap<String, serde_json::Value>, status: Option<&str>, content_encoding: Option<&str>) -> Result<serde_json::Value, Error<ActRunsLastKeyValueStoreRecordPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_record_key = record_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastKeyValueStoreRecordPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_key_value_store_record_put(configuration: &configuration::Configuration, actor_id: &str, record_key: &str, request_body: std::collections::HashMap<String, serde_json::Value>, status: Option<&str>, content_encoding: Option<&str>) -> Result<serde_json::Value, Error<ActRunsLastKeyValueStoreRecordPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_path_record_key = record_key;
    let p_body_request_body = request_body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastKeyValueStoreRecordPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn act_runs_last_key_value_store_records_get(configuration: &configuration::Configuration, actor_id: &str, status: Option<&str>, collection: Option<&str>, prefix: Option<&str>, signature: Option<&str>) -> Result<reqwest::Response, Error<ActRunsLastKeyValueStoreRecordsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_actor_id = actor_id;
    let p_query_status = status;
    let p_query_collection = collection;
    ...
    let uri_str = format!("{}/v2/actors/{actorId}/runs/last/key-value-store/records", configuration.base_path, actorId=crate::apis::urlencode(p_path_actor_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActRunsLastKeyValueStoreRecordsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
