...
/// struct for typed errors of method [`request_queue_head_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueHeadGetError {
...
/// struct for typed errors of method [`request_queue_head_lock_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueHeadLockPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`request_queue_request_lock_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueRequestLockDeleteError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`request_queue_request_lock_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueRequestLockPutError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`request_queue_requests_unlock_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RequestQueueRequestsUnlockPostError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn request_queue_head_get(configuration: &configuration::Configuration, queue_id: &str, limit: Option<f64>, client_key: Option<&str>) -> Result<models::HeadResponse, Error<RequestQueueHeadGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    let p_query_limit = limit;
    let p_query_client_key = client_key;

    let uri_str = format!("{}/v2/request-queues/{queueId}/head", configuration.base_path, queueId=crate::apis::urlencode(p_path_queue_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueueHeadGetError> = serde_json::from_str(&content).ok();
...
pub async fn request_queue_head_lock_post(configuration: &configuration::Configuration, queue_id: &str, lock_secs: f64, limit: Option<f64>, client_key: Option<&str>) -> Result<models::HeadAndLockResponse, Error<RequestQueueHeadLockPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    ...
    let uri_str = format!("{}/v2/request-queues/{queueId}/head/lock", configuration.base_path, queueId=crate::apis::urlencode(p_path_queue_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueueHeadLockPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn request_queue_request_lock_delete(configuration: &configuration::Configuration, queue_id: &str, request_id: &str, client_key: Option<&str>, forefront: Option<&str>) -> Result<(), Error<RequestQueueRequestLockDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    ...
    let uri_str = format!("{}/v2/request-queues/{queueId}/requests/{requestId}/lock", configuration.base_path, queueId=crate::apis::urlencode(p_path_queue_id), requestId=crate::apis::urlencode(p_path_request_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueueRequestLockDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn request_queue_request_lock_put(configuration: &configuration::Configuration, queue_id: &str, request_id: &str, lock_secs: f64, client_key: Option<&str>, forefront: Option<&str>) -> Result<models::ProlongRequestLockResponse, Error<RequestQueueRequestLockPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    let p_path_request_id = request_id;
    let p_query_lock_secs = lock_secs;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueueRequestLockPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn request_queue_requests_unlock_post(configuration: &configuration::Configuration, queue_id: &str, client_key: Option<&str>) -> Result<models::UnlockRequestsResponse, Error<RequestQueueRequestsUnlockPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_queue_id = queue_id;
    let p_query_client_key = client_key;

    let uri_str = format!("{}/v2/request-queues/{queueId}/requests/unlock", configuration.base_path, queueId=crate::apis::urlencode(p_path_queue_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RequestQueueRequestsUnlockPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
