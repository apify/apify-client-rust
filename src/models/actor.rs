...
pub struct Actor {
    ...
    #[serde(rename = "restartOnError", skip_serializing_if = "Option::is_none")]
    pub restart_on_error: Option<bool>,
    #[serde(rename = "isPublic")]
    pub is_public: bool,
    #[serde(rename = "actorPermissionLevel", skip_serializing_if = "Option::is_none")]
    pub actor_permission_level: Option<models::ActorPermissionLevel>,
    #[serde(rename = "createdAt")]
    pub created_at: chrono::DateTime<chrono::FixedOffset>,
    #[serde(rename = "modifiedAt")]
    pub modified_at: chrono::DateTime<chrono::FixedOffset>,
    #[serde(rename = "stats")]
    pub stats: Box<models::ActorStats>,
    /// 
    #[serde(rename = "versions")]
    pub versions: Vec<models::Version>,
    #[serde(rename = "pricingInfos", skip_serializing_if = "Option::is_none")]
    pub pricing_infos: Option<Vec<models::ActorRunPricingInfo>>,
    #[serde(rename = "defaultRunOptions")]
    pub default_run_options: Box<models::DefaultRunOptions>,
    #[serde(rename = "exampleRunInput", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub example_run_input: Option<Option<Box<models::ExampleRunInput>>>,
    #[serde(rename = "isDeprecated", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub is_deprecated: Option<Option<bool>>,
    ...
    #[serde(rename = "taggedBuilds", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tagged_builds: Option<Option<std::collections::HashMap<String, models::TaggedBuildsValue>>>,
    #[serde(rename = "actorStandby", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub actor_standby: Option<Option<Box<models::ActorStandby>>>,
    /// A brief, LLM-generated readme summary
    #[serde(rename = "readmeSummary", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "seoDescription", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub seo_description: Option<Option<String>>,
    #[serde(rename = "pictureUrl", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub picture_url: Option<Option<String>>,
    #[serde(rename = "standbyUrl", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub standby_url: Option<Option<String>>,
    ...
    #[serde(rename = "isGeneric", skip_serializing_if = "Option::is_none")]
    pub is_generic: Option<bool>,
    #[serde(rename = "isSourceCodeHidden", skip_serializing_if = "Option::is_none")]
    pub is_source_code_hidden: Option<bool>,
    #[serde(rename = "hasNoDataset", skip_serializing_if = "Option::is_none")]
    pub has_no_dataset: Option<bool>,
}

impl Actor {
    pub fn new(id: String, user_id: String, name: String, username: String, is_public: bool, created_at: chrono::DateTime<chrono::FixedOffset>, modified_at: chrono::DateTime<chrono::FixedOffset>, stats: models::ActorStats, versions: Vec<models::Version>, default_run_options: models::DefaultRunOptions) -> Actor {
        Actor {
            id,
            user_id,
            name,
            ...
            is_public,
            actor_permission_level: None,
            created_at,
            modified_at,
            stats: Box::new(stats),
            versions,
            pricing_infos: None,
            default_run_options: Box::new(default_run_options),
            example_run_input: None,
            is_deprecated: None,
            deployment_key: None,
            title: None,
            tagged_builds: None,
