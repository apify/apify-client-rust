...
pub struct Run {
    ...
    #[serde(rename = "actorTaskId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub actor_task_id: Option<Option<String>>,
    ...
    #[serde(rename = "status")]
    pub status: models::ActorJobStatus,
    ...
    #[serde(rename = "isStatusMessageTerminal", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub is_status_message_terminal: Option<Option<bool>>,
    /// Metadata about the Actor run.
    #[serde(rename = "meta")]
    pub meta: Box<models::RunMeta>,
    /// Pricing information for the Actor.
    #[serde(rename = "pricingInfo", skip_serializing_if = "Option::is_none")]
    pub pricing_info: Option<Box<models::ActorRunPricingInfo>>,
    ...
    #[serde(rename = "chargedEventCounts", skip_serializing_if = "Option::is_none")]
    pub charged_event_counts: Option<std::collections::HashMap<String, i32>>,
    /// Configuration options for the Actor run.
    #[serde(rename = "options")]
    pub options: Box<models::RunOptions>,
    ...
    pub general_access: models::GeneralAccess,
    ...
    #[serde(rename = "storageIds", skip_serializing_if = "Option::is_none")]
    pub storage_ids: Option<Box<models::RunStorageIds>>,
    /// Build number of the Actor build used for this run.
    #[serde(rename = "buildNumber", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub build_number: Option<Option<String>>,
    /// URL of the container running the Actor.
    #[serde(rename = "containerUrl", skip_serializing_if = "Option::is_none")]
    pub container_url: Option<String>,
    /// Whether the container's HTTP server is ready to accept requests.
    #[serde(rename = "isContainerServerReady", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub is_container_server_ready: Option<Option<bool>>,
    /// Name of the git branch used for the Actor build.
    #[serde(rename = "gitBranchName", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub git_branch_name: Option<Option<String>>,
    ...
    pub usage: Option<Option<Box<models::RunUsage>>>,
    ...
    #[serde(rename = "usageTotalUsd", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub usage_total_usd: Option<Option<f64>>,
    ...
    #[serde(rename = "usageUsd", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub usage_usd: Option<Option<Box<models::RunUsageUsd>>>,
    /// List of metamorph events that occurred during the run.
    #[serde(rename = "metamorphs", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub metamorphs: Option<Option<Vec<models::Metamorph>>>,
    /// Indicates which party covers platform usage costs for this run.
    #[serde(rename = "platformUsageBillingModel", skip_serializing_if = "Option::is_none")]
    pub platform_usage_billing_model: Option<String>,
}

impl Run {
    /// Represents an Actor run and its associated data.
    pub fn new(id: String, act_id: String, user_id: String, started_at: chrono::DateTime<chrono::FixedOffset>, status: models::ActorJobStatus, meta: models::RunMeta, stats: models::RunStats, options: models::RunOptions, build_id: String, general_access: models::GeneralAccess, default_key_value_store_id: String, default_dataset_id: String, default_request_queue_id: String) -> Run {
        Run {
            id,
            act_id,
            user_id,
            ...
            build_number: None,
            container_url: None,
            is_container_server_ready: None,
            git_branch_name: None,
            usage: None,
            usage_total_usd: None,
            usage_usd: None,
            metamorphs: None,
            platform_usage_billing_model: None,
        }
    }
}
