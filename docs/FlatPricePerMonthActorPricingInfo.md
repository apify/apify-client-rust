...
**pricing_model** | **PricingModel** |  (enum: FLAT_PRICE_PER_MONTH) | 
**trial_minutes** | **i32** | For how long this Actor can be used for free in trial period | 
**price_per_unit_usd** | **f64** | Monthly flat price in USD | 
