...
**pricing_model** | **PricingModel** |  (enum: PAY_PER_EVENT) | 
**pricing_per_event** | [**models::PayPerEventActorPricingInfoAllOfPricingPerEvent**](PayPerEventActorPricingInfoAllOfPricingPerEvent.md) |  | 
